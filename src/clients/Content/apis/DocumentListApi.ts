...
/**
 * DocumentListApi - interface
 * 
 * @export
 * @interface DocumentListApiInterface
 */
export interface DocumentListApiInterface {
    /**
     * Create DocumentList
 ...
 * 
 */
export class DocumentListApi extends runtime.BaseAPI implements DocumentListApiInterface {
