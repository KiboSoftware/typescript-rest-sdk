...
export class ExportInventoryApi extends runtime.BaseAPI implements ExportInventoryApiService {
    ...
    async deleteExportSettingsRaw(requestParameters: exportInventoryApiParams.DeleteExportSettingsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeletedCountResponse>> {
        ...
        const response = await this.request({
            path: `/commerce/inventory/v1/export/{exportSettingsName}`.replace(`{${"exportSettingsName"}}`, encodeURIComponent(String(requestParameters.exportSettingsName))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async deleteExportSettingsFTPRaw(requestParameters: exportInventoryApiParams.DeleteExportSettingsFTPRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeletedCountResponse>> {
        ...
        if (requestParameters.exportSettingsFTPName === null || requestParameters.exportSettingsFTPName === undefined) {
            throw new runtime.RequiredError('exportSettingsFTPName','Required parameter requestParameters.exportSettingsFTPName was null or undefined when calling deleteExportSettingsFTP.');
        }
        ...
        const response = await this.request({
            path: `/commerce/inventory/v1/export/ftp/{exportSettingsName}/{exportSettingsFTPName}`.replace(`{${"exportSettingsName"}}`, encodeURIComponent(String(requestParameters.exportSettingsName))).replace(`{${"exportSettingsFTPName"}}`, encodeURIComponent(String(requestParameters.exportSettingsFTPName))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async deleteExportSettingsS3Raw(requestParameters: exportInventoryApiParams.DeleteExportSettingsS3Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeletedCountResponse>> {
        ...
        if (requestParameters.exportSettingsS3Name === null || requestParameters.exportSettingsS3Name === undefined) {
            throw new runtime.RequiredError('exportSettingsS3Name','Required parameter requestParameters.exportSettingsS3Name was null or undefined when calling deleteExportSettingsS3.');
        }
        ...
        const response = await this.request({
            path: `/commerce/inventory/v1/export/s3/{exportSettingsName}/{exportSettingsS3Name}`.replace(`{${"exportSettingsName"}}`, encodeURIComponent(String(requestParameters.exportSettingsName))).replace(`{${"exportSettingsS3Name"}}`, encodeURIComponent(String(requestParameters.exportSettingsS3Name))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
