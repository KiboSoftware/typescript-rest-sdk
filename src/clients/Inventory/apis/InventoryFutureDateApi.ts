...
export interface InventoryFutureDateApiService {
    ...
    */
    adjustFutureDateRaw(requestParameters: inventoryFutureDateApiParams.AdjustFutureDateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JobQueueResponse>>;

    /**
    * Adjust future_date of future inventory
    * Adjust Future Date
    */
    adjustFutureDate(requestParameters: inventoryFutureDateApiParams.AdjustFutureDateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JobQueueResponse>;
...
export class InventoryFutureDateApi extends runtime.BaseAPI implements InventoryFutureDateApiService {
    ...
    async adjustFutureDateRaw(requestParameters: inventoryFutureDateApiParams.AdjustFutureDateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JobQueueResponse>> {
     ...
     * Adjust Future Date
     */
    async adjustFutureDate(requestParameters: inventoryFutureDateApiParams.AdjustFutureDateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JobQueueResponse> {
