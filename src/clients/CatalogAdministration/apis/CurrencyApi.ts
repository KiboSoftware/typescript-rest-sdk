...
export interface CurrencyApiGetCurrencyLocalizationsRequest {
    responseFields?: string;
}
...
export interface CurrencyApiInterface {
     ...
     */
    addCurrencyExchangeRatesRaw(requestParameters: CurrencyApiAddCurrencyExchangeRatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Updates the details of a currency-localization.
     * Update currency localization
     */
    addCurrencyExchangeRates(requestParameters: CurrencyApiAddCurrencyExchangeRatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof CurrencyApiInterface
     */
    addCurrencyLocalizationRaw(requestParameters: CurrencyApiAddCurrencyLocalizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyLocalization>>;

    /**
     * Adds a new currency localization
     * Add currency localization
     */
    addCurrencyLocalization(requestParameters: CurrencyApiAddCurrencyLocalizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyLocalization>;
     ...
     * @memberof CurrencyApiInterface
     */
    deleteCurrencyExchangeRateRaw(requestParameters: CurrencyApiDeleteCurrencyExchangeRateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Delete a single exchange rate for a specified currency-code and target currency-code.
     * Delete currency exchange rate
     */
    deleteCurrencyExchangeRate(requestParameters: CurrencyApiDeleteCurrencyExchangeRateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof CurrencyApiInterface
     */
    deleteCurrencyLocalizationRaw(requestParameters: CurrencyApiDeleteCurrencyLocalizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Deletes the currency-localization specified by its currency code.
     * Delete currency localization
     */
    deleteCurrencyLocalization(requestParameters: CurrencyApiDeleteCurrencyLocalizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof CurrencyApiInterface
     */
    getCurrencyExchangeRateRaw(requestParameters: CurrencyApiGetCurrencyExchangeRateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CatalogAdminsCurrencyExchangeRate>>;

    /**
     * Retrieves a single exchange rate for a specified currency-code and target-currency-code.
     * Get currency exchange rate
     */
    getCurrencyExchangeRate(requestParameters: CurrencyApiGetCurrencyExchangeRateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CatalogAdminsCurrencyExchangeRate>;
     ...
     * @memberof CurrencyApiInterface
     */
    getCurrencyExchangeRatesRaw(requestParameters: CurrencyApiGetCurrencyExchangeRatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyExchangeRateCollection>>;

    /**
     * Retrieves a list of exchange rates for a specified currency-code and filter criteria.
     * Get currency exchange rates
     */
    getCurrencyExchangeRates(requestParameters: CurrencyApiGetCurrencyExchangeRatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyExchangeRateCollection>;
     ...
     * @memberof CurrencyApiInterface
     */
    getCurrencyLocalizationRaw(requestParameters: CurrencyApiGetCurrencyLocalizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyLocalization>>;

    /**
     * Gets a single currency-localization.
     * Get currency localization
     */
    getCurrencyLocalization(requestParameters: CurrencyApiGetCurrencyLocalizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyLocalization>;
     ...
     * @memberof CurrencyApiInterface
     */
    getCurrencyLocalizationsRaw(requestParameters: CurrencyApiGetCurrencyLocalizationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyLocalizationCollection>>;

    /**
     * Gets all currency-localizations.
     * Get currency localizations
     */
    getCurrencyLocalizations(requestParameters: CurrencyApiGetCurrencyLocalizationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyLocalizationCollection>;
     ...
     * @memberof CurrencyApiInterface
     */
    updateCurrencyExchangeRatesRaw(requestParameters: CurrencyApiUpdateCurrencyExchangeRatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     * Update multiple exchange rates for a specified currency-code.
     * Update currency exchange rates
     */
    updateCurrencyExchangeRates(requestParameters: CurrencyApiUpdateCurrencyExchangeRatesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof CurrencyApiInterface
     */
    updateCurrencyLocalizationRaw(requestParameters: CurrencyApiUpdateCurrencyLocalizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyLocalization>>;

    /**
     * Updates the details of a currency-localization.
     * Update currency localization
     */
    updateCurrencyLocalization(requestParameters: CurrencyApiUpdateCurrencyLocalizationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyLocalization>;
...
export class CurrencyApi extends runtime.BaseAPI implements CurrencyApiInterface {
    ...
    async getCurrencyExchangeRateRaw(requestParameters: CurrencyApiGetCurrencyExchangeRateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CatalogAdminsCurrencyExchangeRate>> {
        if (requestParameters.currencyCode === null || requestParameters.currencyCode === undefined) {
     ...
     * Get currency exchange rate
     */
    async getCurrencyExchangeRate(requestParameters: CurrencyApiGetCurrencyExchangeRateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CatalogAdminsCurrencyExchangeRate> {
    ...
    async getCurrencyLocalizationsRaw(requestParameters: CurrencyApiGetCurrencyLocalizationsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyLocalizationCollection>> {
        const queryParameters: any = {};
     ...
     * Get currency localizations
     */
    async getCurrencyLocalizations(requestParameters: CurrencyApiGetCurrencyLocalizationsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyLocalizationCollection> {
