...
import type {
  ProblemDetails,
  RulesEngineJobCreateRequest,
  RulesEngineJobCreateResponse,
} from '../models';


export namespace rulesEngineJobsApiParams { 
    export interface CreateJobRequest {
        responseFields?: string;
        rulesEngineJobCreateRequest?: RulesEngineJobCreateRequest;
    }
}
/**
* RulesEngineJobsApiService - interface
* 
* @export
* @interface RulesEngineJobsApi
*/
export interface RulesEngineJobsApiService {
    /**
    ...
    * @summary Create rules engine job
    * @param {string} [responseFields] limits which fields are returned in the response body
    * @param {RulesEngineJobCreateRequest} [rulesEngineJobCreateRequest] 
    * @param {*} [options] Override http request option.
    * @throws {RequiredError}
    * @memberof RulesEngineJobsApiInterface
    */
    createJobRaw(requestParameters: rulesEngineJobsApiParams.CreateJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RulesEngineJobCreateResponse>>;

    /**
    * Creates a new rules engine job, updates matching MZDB event statuses, and enqueues a RulesEngineJobCreatedEvent for publication. Publication is fire-and-forget via the internal message bus — a 201 response confirms the job was created and events were updated, but does not guarantee consumers have received the event. StampedCount reflects the number of events modified; SkippedCount reflects events that matched but were already in the target status.
    * Create rules engine job
    */
    createJob(requestParameters: rulesEngineJobsApiParams.CreateJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RulesEngineJobCreateResponse>;
 ...
 * 
 */
export class RulesEngineJobsApi extends runtime.BaseAPI implements RulesEngineJobsApiService {
    ...
    async createJobRaw(requestParameters: rulesEngineJobsApiParams.CreateJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RulesEngineJobCreateResponse>> {
        ...
        const response = await this.request({
            path: `/commerce/rules/jobs`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters.rulesEngineJobCreateRequest,
        }, initOverrides);
     ...
     * Create rules engine job
     */
    async createJob(requestParameters: rulesEngineJobsApiParams.CreateJobRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RulesEngineJobCreateResponse> {
