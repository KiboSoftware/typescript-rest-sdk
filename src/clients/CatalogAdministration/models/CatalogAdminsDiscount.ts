...
import type { CatalogAdminsDiscountCondition } from './CatalogAdminsDiscountCondition';
import {
    CatalogAdminsDiscountConditionFromJSON,
    CatalogAdminsDiscountConditionFromJSONTyped,
    CatalogAdminsDiscountConditionToJSON,
} from './CatalogAdminsDiscountCondition';
import type { CatalogAdminsDiscountTarget } from './CatalogAdminsDiscountTarget';
import {
    CatalogAdminsDiscountTargetFromJSON,
    CatalogAdminsDiscountTargetFromJSONTyped,
    CatalogAdminsDiscountTargetToJSON,
} from './CatalogAdminsDiscountTarget';
import type { CatalogAdminsThresholdMessage } from './CatalogAdminsThresholdMessage';
import {
    CatalogAdminsThresholdMessageFromJSON,
    CatalogAdminsThresholdMessageFromJSONTyped,
    CatalogAdminsThresholdMessageToJSON,
} from './CatalogAdminsThresholdMessage';
...
/**
 * Check if a given object implements the CatalogAdminsDiscount interface.
 */
export function instanceOfCatalogAdminsDiscount(value: object): boolean {
    let isInstance = true;
...
export function CatalogAdminsDiscountFromJSON(json: any): CatalogAdminsDiscount {
    return CatalogAdminsDiscountFromJSONTyped(json, false);
}

export function CatalogAdminsDiscountFromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogAdminsDiscount {
    ...
    return {
        ...
        'scope': json['scope'],
        'conditions': !exists(json, 'conditions') ? undefined : CatalogAdminsDiscountConditionFromJSON(json['conditions']),
        'target': CatalogAdminsDiscountTargetFromJSON(json['target']),
        ...
        'thresholdMessage': !exists(json, 'thresholdMessage') ? undefined : CatalogAdminsThresholdMessageFromJSON(json['thresholdMessage']),
...
export function CatalogAdminsDiscountToJSON(value?: CatalogAdminsDiscount | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'scope': value.scope,
        'conditions': CatalogAdminsDiscountConditionToJSON(value.conditions),
        'target': CatalogAdminsDiscountTargetToJSON(value.target),
        ...
        'thresholdMessage': CatalogAdminsThresholdMessageToJSON(value.thresholdMessage),
