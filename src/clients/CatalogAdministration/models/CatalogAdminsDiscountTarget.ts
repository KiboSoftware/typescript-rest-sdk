...
/**
 * Check if a given object implements the CatalogAdminsDiscountTarget interface.
 */
export function instanceOfCatalogAdminsDiscountTarget(value: object): boolean {
    let isInstance = true;
...
export function CatalogAdminsDiscountTargetFromJSON(json: any): CatalogAdminsDiscountTarget {
    return CatalogAdminsDiscountTargetFromJSONTyped(json, false);
}

export function CatalogAdminsDiscountTargetFromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogAdminsDiscountTarget {
...
export function CatalogAdminsDiscountTargetToJSON(value?: CatalogAdminsDiscountTarget | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
