...
import type { CatalogRuntimesProductCollectionInfo } from './CatalogRuntimesProductCollectionInfo';
import {
    CatalogRuntimesProductCollectionInfoFromJSON,
    CatalogRuntimesProductCollectionInfoFromJSONTyped,
    CatalogRuntimesProductCollectionInfoToJSON,
} from './CatalogRuntimesProductCollectionInfo';
import type { CatalogRuntimesProductImageGroup } from './CatalogRuntimesProductImageGroup';
import {
    CatalogRuntimesProductImageGroupFromJSON,
    CatalogRuntimesProductImageGroupFromJSONTyped,
    CatalogRuntimesProductImageGroupToJSON,
} from './CatalogRuntimesProductImageGroup';
...
import type { CatalogRuntimesProductOption } from './CatalogRuntimesProductOption';
import {
    CatalogRuntimesProductOptionFromJSON,
    CatalogRuntimesProductOptionFromJSONTyped,
    CatalogRuntimesProductOptionToJSON,
} from './CatalogRuntimesProductOption';
import type { CatalogRuntimesProductPrice } from './CatalogRuntimesProductPrice';
import {
    CatalogRuntimesProductPriceFromJSON,
    CatalogRuntimesProductPriceFromJSONTyped,
    CatalogRuntimesProductPriceToJSON,
} from './CatalogRuntimesProductPrice';
import type { CatalogRuntimesProductPricingBehaviorInfo } from './CatalogRuntimesProductPricingBehaviorInfo';
import {
    CatalogRuntimesProductPricingBehaviorInfoFromJSON,
    CatalogRuntimesProductPricingBehaviorInfoFromJSONTyped,
    CatalogRuntimesProductPricingBehaviorInfoToJSON,
} from './CatalogRuntimesProductPricingBehaviorInfo';
import type { CatalogRuntimesProductProperty } from './CatalogRuntimesProductProperty';
import {
    CatalogRuntimesProductPropertyFromJSON,
    CatalogRuntimesProductPropertyFromJSONTyped,
    CatalogRuntimesProductPropertyToJSON,
} from './CatalogRuntimesProductProperty';
...
/**
 * Check if a given object implements the CatalogRuntimesProduct interface.
 */
export function instanceOfCatalogRuntimesProduct(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CatalogRuntimesProductFromJSON(json: any): CatalogRuntimesProduct {
    return CatalogRuntimesProductFromJSONTyped(json, false);
}

export function CatalogRuntimesProductFromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogRuntimesProduct {
    ...
    return {
        ...
        'bundledProducts': !exists(json, 'bundledProducts') ? undefined : (json['bundledProducts'] === null ? null : (json['bundledProducts'] as Array<any>).map(CatalogRuntimesBundledProductFromJSON)),
        ...
        'price': !exists(json, 'price') ? undefined : CatalogRuntimesProductPriceFromJSON(json['price']),
        ...
        'availableShippingDiscounts': !exists(json, 'availableShippingDiscounts') ? undefined : (json['availableShippingDiscounts'] === null ? null : (json['availableShippingDiscounts'] as Array<any>).map(CatalogRuntimesDiscountFromJSON)),
        ...
        'pricingBehavior': !exists(json, 'pricingBehavior') ? undefined : CatalogRuntimesProductPricingBehaviorInfoFromJSON(json['pricingBehavior']),
        ...
        'categories': !exists(json, 'categories') ? undefined : (json['categories'] === null ? null : (json['categories'] as Array<any>).map(CatalogRuntimesCategoryFromJSON)),
        ...
        'properties': !exists(json, 'properties') ? undefined : (json['properties'] === null ? null : (json['properties'] as Array<any>).map(CatalogRuntimesProductPropertyFromJSON)),
        'options': !exists(json, 'options') ? undefined : (json['options'] === null ? null : (json['options'] as Array<any>).map(CatalogRuntimesProductOptionFromJSON)),
        ...
        'productImageGroups': !exists(json, 'productImageGroups') ? undefined : (json['productImageGroups'] === null ? null : (json['productImageGroups'] as Array<any>).map(CatalogRuntimesProductImageGroupFromJSON)),
        'sliceValue': !exists(json, 'sliceValue') ? undefined : json['sliceValue'],
        'productCollections': !exists(json, 'productCollections') ? undefined : (json['productCollections'] === null ? null : (json['productCollections'] as Array<any>).map(CatalogRuntimesProductCollectionInfoFromJSON)),
...
export function CatalogRuntimesProductToJSON(value?: CatalogRuntimesProduct | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'bundledProducts': value.bundledProducts === undefined ? undefined : (value.bundledProducts === null ? null : (value.bundledProducts as Array<any>).map(CatalogRuntimesBundledProductToJSON)),
        ...
        'price': CatalogRuntimesProductPriceToJSON(value.price),
        ...
        'availableShippingDiscounts': value.availableShippingDiscounts === undefined ? undefined : (value.availableShippingDiscounts === null ? null : (value.availableShippingDiscounts as Array<any>).map(CatalogRuntimesDiscountToJSON)),
        'productType': value.productType,
        'productTypeId': value.productTypeId,
        'isTaxable': value.isTaxable,
        'isRecurring': value.isRecurring,
        'pricingBehavior': CatalogRuntimesProductPricingBehaviorInfoToJSON(value.pricingBehavior),
        ...
        'categories': value.categories === undefined ? undefined : (value.categories === null ? null : (value.categories as Array<any>).map(CatalogRuntimesCategoryToJSON)),
        'measurements': CatalogRuntimesPackageMeasurementsToJSON(value.measurements),
        'isPackagedStandAlone': value.isPackagedStandAlone,
        'properties': value.properties === undefined ? undefined : (value.properties === null ? null : (value.properties as Array<any>).map(CatalogRuntimesProductPropertyToJSON)),
        'options': value.options === undefined ? undefined : (value.options === null ? null : (value.options as Array<any>).map(CatalogRuntimesProductOptionToJSON)),
        ...
        'productImageGroups': value.productImageGroups === undefined ? undefined : (value.productImageGroups === null ? null : (value.productImageGroups as Array<any>).map(CatalogRuntimesProductImageGroupToJSON)),
        'sliceValue': value.sliceValue,
        'productCollections': value.productCollections === undefined ? undefined : (value.productCollections === null ? null : (value.productCollections as Array<any>).map(CatalogRuntimesProductCollectionInfoToJSON)),
