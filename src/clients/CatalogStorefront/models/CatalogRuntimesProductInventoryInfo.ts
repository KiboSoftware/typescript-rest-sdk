...
/**
 * Check if a given object implements the CatalogRuntimesProductInventoryInfo interface.
 */
export function instanceOfCatalogRuntimesProductInventoryInfo(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CatalogRuntimesProductInventoryInfoFromJSON(json: any): CatalogRuntimesProductInventoryInfo {
    return CatalogRuntimesProductInventoryInfoFromJSONTyped(json, false);
}

export function CatalogRuntimesProductInventoryInfoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CatalogRuntimesProductInventoryInfo {
...
export function CatalogRuntimesProductInventoryInfoToJSON(value?: CatalogRuntimesProductInventoryInfo | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
