...
/**
 * Check if a given object implements the ProductForIndexing interface.
 */
export function instanceOfProductForIndexing(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function ProductForIndexingFromJSON(json: any): ProductForIndexing {
    return ProductForIndexingFromJSONTyped(json, false);
}

export function ProductForIndexingFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProductForIndexing {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'slices': !exists(json, 'slices') ? undefined : (json['slices'] === null ? null : (json['slices'] as Array<any>).map(ProductFromJSON)),
...
export function ProductForIndexingToJSON(value?: ProductForIndexing | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'slices': value.slices === undefined ? undefined : (value.slices === null ? null : (value.slices as Array<any>).map(ProductToJSON)),
