...
export namespace subscriptionApiParams { 
    ...
    export interface CreateSubscriptionLineAttributesRequest {
        subscriptionId: string;
        subscriptionItemId: string;
        updateMode?: string;
        responseFields?: string;
        subscriptionLineAttribute?: Array<SubscriptionLineAttribute>;
    }
    ...
    export interface DeleteSubscriptionLineAttributeRequest {
        subscriptionId: string;
        subscriptionItemId: string;
        attributeFqn: string;
        updateMode?: string;
    ...
    export interface GetSubscriptionLineAttributesRequest {
        subscriptionId: string;
        subscriptionItemId: string;
        draft?: boolean;
        responseFields?: string;
    ...
    export interface UpdateSubscriptionLineAttributesRequest {
        subscriptionId: string;
        subscriptionItemId: string;
        removeMissing?: boolean;
        updateMode?: string;
...
export interface SubscriptionApiService {
    ...
    * @summary Create line-level attributes on a subscription item; skips FQNs that already exist
    * @param {string} subscriptionId 
    * @param {string} subscriptionItemId 
    * @param {string} [updateMode] 
    * @param {string} [responseFields] limits which fields are returned in the response body
    * @param {Array<SubscriptionLineAttribute>} [subscriptionLineAttribute] 
    * @param {*} [options] Override http request option.
    * @throws {RequiredError}
    * @memberof SubscriptionApiInterface
    */
    createSubscriptionLineAttributesRaw(requestParameters: subscriptionApiParams.CreateSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubscriptionLineAttribute>>>;

    /**
    * Create line-level attributes on a subscription item; skips FQNs that already exist.
    * Create line-level attributes on a subscription item; skips FQNs that already exist
    */
    createSubscriptionLineAttributes(requestParameters: subscriptionApiParams.CreateSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubscriptionLineAttribute>>;
    ...
    * @summary Delete a single line-level attribute from a subscription item by FQN
    * @param {string} subscriptionId 
    * @param {string} subscriptionItemId 
    ...
    * @memberof SubscriptionApiInterface
    */
    deleteSubscriptionLineAttributeRaw(requestParameters: subscriptionApiParams.DeleteSubscriptionLineAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
    * Delete a single line-level attribute from a subscription item by FQN.
    * Delete a single line-level attribute from a subscription item by FQN
    */
    deleteSubscriptionLineAttribute(requestParameters: subscriptionApiParams.DeleteSubscriptionLineAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
    ...
    * @summary Get all line-level attributes for a subscription item
    * @param {string} subscriptionId 
    * @param {string} subscriptionItemId 
    * @param {boolean} [draft] 
    * @param {string} [responseFields] limits which fields are returned in the response body
    ...
    * @memberof SubscriptionApiInterface
    */
    getSubscriptionLineAttributesRaw(requestParameters: subscriptionApiParams.GetSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubscriptionLineAttribute>>>;

    /**
    * Get all line-level attributes for a subscription item.
    * Get all line-level attributes for a subscription item
    */
    getSubscriptionLineAttributes(requestParameters: subscriptionApiParams.GetSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubscriptionLineAttribute>>;
    ...
    * @memberof SubscriptionApiInterface
    */
    updateSubscriptionLineAttributesRaw(requestParameters: subscriptionApiParams.UpdateSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubscriptionLineAttribute>>>;

    /**
    * Upsert line-level attributes on a subscription item.
    * Upsert line-level attributes on a subscription item
    */
    updateSubscriptionLineAttributes(requestParameters: subscriptionApiParams.UpdateSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubscriptionLineAttribute>>;
...
export class SubscriptionApi extends runtime.BaseAPI implements SubscriptionApiService {
    ...
    async createSubscriptionLineAttributesRaw(requestParameters: subscriptionApiParams.CreateSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubscriptionLineAttribute>>> {
        if (requestParameters.subscriptionId === null || requestParameters.subscriptionId === undefined) {
            throw new runtime.RequiredError('subscriptionId','Required parameter requestParameters.subscriptionId was null or undefined when calling createSubscriptionLineAttributes.');
        }

        if (requestParameters.subscriptionItemId === null || requestParameters.subscriptionItemId === undefined) {
            throw new runtime.RequiredError('subscriptionItemId','Required parameter requestParameters.subscriptionItemId was null or undefined when calling createSubscriptionLineAttributes.');
        }
        ...
        const response = await this.request({
            path: `/commerce/subscriptions/{subscriptionId}/items/{subscriptionItemId}/attributes`.replace(`{${"subscriptionId"}}`, encodeURIComponent(String(requestParameters.subscriptionId))).replace(`{${"subscriptionItemId"}}`, encodeURIComponent(String(requestParameters.subscriptionItemId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters.subscriptionLineAttribute,
        }, initOverrides);
     ...
     * Create line-level attributes on a subscription item; skips FQNs that already exist
     */
    async createSubscriptionLineAttributes(requestParameters: subscriptionApiParams.CreateSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubscriptionLineAttribute>> {
        const response = await this.createSubscriptionLineAttributesRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async deleteSubscriptionLineAttributeRaw(requestParameters: subscriptionApiParams.DeleteSubscriptionLineAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.subscriptionId === null || requestParameters.subscriptionId === undefined) {
            throw new runtime.RequiredError('subscriptionId','Required parameter requestParameters.subscriptionId was null or undefined when calling deleteSubscriptionLineAttribute.');
        }

        if (requestParameters.subscriptionItemId === null || requestParameters.subscriptionItemId === undefined) {
            throw new runtime.RequiredError('subscriptionItemId','Required parameter requestParameters.subscriptionItemId was null or undefined when calling deleteSubscriptionLineAttribute.');
        }

        if (requestParameters.attributeFqn === null || requestParameters.attributeFqn === undefined) {
            throw new runtime.RequiredError('attributeFqn','Required parameter requestParameters.attributeFqn was null or undefined when calling deleteSubscriptionLineAttribute.');
        }
     ...
     * Delete a single line-level attribute from a subscription item by FQN
     */
    async deleteSubscriptionLineAttribute(requestParameters: subscriptionApiParams.DeleteSubscriptionLineAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteSubscriptionLineAttributeRaw(requestParameters, initOverrides);
    }
    ...
    async getSubscriptionLineAttributesRaw(requestParameters: subscriptionApiParams.GetSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubscriptionLineAttribute>>> {
        if (requestParameters.subscriptionId === null || requestParameters.subscriptionId === undefined) {
            throw new runtime.RequiredError('subscriptionId','Required parameter requestParameters.subscriptionId was null or undefined when calling getSubscriptionLineAttributes.');
        }

        if (requestParameters.subscriptionItemId === null || requestParameters.subscriptionItemId === undefined) {
            throw new runtime.RequiredError('subscriptionItemId','Required parameter requestParameters.subscriptionItemId was null or undefined when calling getSubscriptionLineAttributes.');
        }
     ...
     * Get all line-level attributes for a subscription item
     */
    async getSubscriptionLineAttributes(requestParameters: subscriptionApiParams.GetSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubscriptionLineAttribute>> {
        const response = await this.getSubscriptionLineAttributesRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    async updateSubscriptionLineAttributesRaw(requestParameters: subscriptionApiParams.UpdateSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SubscriptionLineAttribute>>> {
        if (requestParameters.subscriptionId === null || requestParameters.subscriptionId === undefined) {
            throw new runtime.RequiredError('subscriptionId','Required parameter requestParameters.subscriptionId was null or undefined when calling updateSubscriptionLineAttributes.');
        }

        if (requestParameters.subscriptionItemId === null || requestParameters.subscriptionItemId === undefined) {
            throw new runtime.RequiredError('subscriptionItemId','Required parameter requestParameters.subscriptionItemId was null or undefined when calling updateSubscriptionLineAttributes.');
        }
     ...
     * Upsert line-level attributes on a subscription item
     */
    async updateSubscriptionLineAttributes(requestParameters: subscriptionApiParams.UpdateSubscriptionLineAttributesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<SubscriptionLineAttribute>> {
        const response = await this.updateSubscriptionLineAttributesRaw(requestParameters, initOverrides);
        return await response.value();
    }
