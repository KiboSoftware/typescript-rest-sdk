...
export namespace locationAdminApiParams { 
    ...
    export interface GetLocationAttributeRequest {
        locationCode: string;
...
export interface LocationAdminApiService {
    ...
    * @summary Create Cutoff Time Override
    * @param {string} [responseFields] limits which fields are returned in the response body
    ...
    * @summary Delete Cutoff Time Override
    ...
    * @summary Get Location Cut Off Time
    ...
    * @summary Get Cutoff Time Overrides
    * @param {string} [locationCode] 
    ...
    * @summary Get Location Attribute
    * @param {string} locationCode The unique code for a location
    * @param {string} fullyQualifiedName The fully qualified name of the attribute to retrieve
    * @param {string} [responseFields] limits which fields are returned in the response body
    * @param {*} [options] Override http request option.
    * @throws {RequiredError}
    * @memberof LocationAdminApiInterface
    */
    getLocationAttributeRaw(requestParameters: locationAdminApiParams.GetLocationAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LocationAttribute>>;

    /**
    * Get a specific attribute from a location.
    * Get Location Attribute
    */
    getLocationAttribute(requestParameters: locationAdminApiParams.GetLocationAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LocationAttribute>;
...
export class LocationAdminApi extends runtime.BaseAPI implements LocationAdminApiService {
    ...
    async getLocationAttributeRaw(requestParameters: locationAdminApiParams.GetLocationAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LocationAttribute>> {
        if (requestParameters.locationCode === null || requestParameters.locationCode === undefined) {
            throw new runtime.RequiredError('locationCode','Required parameter requestParameters.locationCode was null or undefined when calling getLocationAttribute.');
        }

        if (requestParameters.fullyQualifiedName === null || requestParameters.fullyQualifiedName === undefined) {
            throw new runtime.RequiredError('fullyQualifiedName','Required parameter requestParameters.fullyQualifiedName was null or undefined when calling getLocationAttribute.');
        }
     ...
     * Get Location Attribute
     */
    async getLocationAttribute(requestParameters: locationAdminApiParams.GetLocationAttributeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LocationAttribute> {
        const response = await this.getLocationAttributeRaw(requestParameters, initOverrides);
        return await response.value();
    }
