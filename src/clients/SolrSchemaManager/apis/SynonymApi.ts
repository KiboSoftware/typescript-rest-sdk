...
/**
 * SynonymApi - interface
 * 
 * @export
 * @interface SynonymApiInterface
 */
export interface SynonymApiInterface {
    /**
     * List Synonyms
 ...
 * 
 */
export class SynonymApi extends runtime.BaseAPI implements SynonymApiInterface {
