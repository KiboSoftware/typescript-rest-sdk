...
export namespace cartApiParams { 
    ...
    export interface DeleteCartItemsByCartIdRequest {
        cartId: string;
        responseFields?: string;
        requestBody?: Array<string>;
    }
    ...
    export interface UpdateCartItemsByCartIdRequest {
        cartId: string;
        throwErrorOnInvalidItems?: boolean;
        zipCode?: string;
        removeInvalidItems?: boolean;
...
export interface CartApiService {
    ...
    * @param {string} [responseFields] limits which fields are returned in the response body
    * @param {Array<string>} [requestBody] List of cart item IDs to remove
    * @param {*} [options] Override http request option.
    * @throws {RequiredError}
    * @memberof CartApiInterface
    */
    deleteCartItemsRaw(requestParameters: cartApiParams.DeleteCartItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
    * Removes multiple cart items from the cart of the current shopper in a single operation.
    * Delete Multiple Cart Items
    */
    deleteCartItems(requestParameters: cartApiParams.DeleteCartItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;

    /**
    * Removes multiple cart items from the specified cart in a single operation.
    * @summary Delete Multiple Cart Items By CartId
    * @param {string} cartId Unique identifier of the cart
    * @param {string} [responseFields] limits which fields are returned in the response body
    * @param {Array<string>} [requestBody] List of cart item IDs to remove
    * @param {*} [options] Override http request option.
    ...
    * @memberof CartApiInterface
    */
    deleteCartItemsByCartIdRaw(requestParameters: cartApiParams.DeleteCartItemsByCartIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
    * Removes multiple cart items from the specified cart in a single operation.
    * Delete Multiple Cart Items By CartId
    */
    deleteCartItemsByCartId(requestParameters: cartApiParams.DeleteCartItemsByCartIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
    ...
    * @param {boolean} [throwErrorOnInvalidItems] When set to true none of the items will be updated when some items are invalid. when set to false valid items are updated and invalid items are reverted or removed based on removeInvalidItems flag
    * @param {string} [zipCode] Zip Code used for inventory reservation if cart having STH items.
    * @param {boolean} [removeInvalidItems] When set to true and throwErrorOnInvalidItems is false, invalid items will be removed from cart instead of reverted. This parameter is ignored when throwErrorOnInvalidItems is true.
    * @param {string} [responseFields] limits which fields are returned in the response body
    * @param {Array<CartItem>} [cartItem] The items to update in the cart. Each item must include Id property.
    * @param {*} [options] Override http request option.
    * @throws {RequiredError}
    * @memberof CartApiInterface
    */
    updateCartItemsRaw(requestParameters: cartApiParams.UpdateCartItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CartItem>>>;

    /**
    * Updates multiple cart items in the cart of the current shopper.
    * Update Cart Items
    */
    updateCartItems(requestParameters: cartApiParams.UpdateCartItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CartItem>>;

    /**
    * Updates multiple cart items in the cart specified by cartId.
    * @summary Update Cart Items By CartId
    * @param {string} cartId Unique identifier of the cart.
    * @param {boolean} [throwErrorOnInvalidItems] When set to true none of the items will be updated when some items are invalid. when set to false valid items are updated and invalid items are reverted or removed based on removeInvalidItems flag
    * @param {string} [zipCode] Zip Code used for inventory reservation if cart having STH items.
    * @param {boolean} [removeInvalidItems] When set to true and throwErrorOnInvalidItems is false, invalid items will be removed from cart instead of reverted. This parameter is ignored when throwErrorOnInvalidItems is true.
    ...
    * @memberof CartApiInterface
    */
    updateCartItemsByCartIdRaw(requestParameters: cartApiParams.UpdateCartItemsByCartIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CartItem>>>;

    /**
    * Updates multiple cart items in the cart specified by cartId.
    * Update Cart Items By CartId
    */
    updateCartItemsByCartId(requestParameters: cartApiParams.UpdateCartItemsByCartIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CartItem>>;
...
export class CartApi extends runtime.BaseAPI implements CartApiService {
    ...
    async deleteCartItemsRaw(requestParameters: cartApiParams.DeleteCartItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        const queryParameters: any = {};
        ...
        const response = await this.request({
            path: `/commerce/carts/current/bulkitems/delete`,
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
     ...
     * Delete Multiple Cart Items
     */
    async deleteCartItems(requestParameters: cartApiParams.DeleteCartItemsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteCartItemsRaw(requestParameters, initOverrides);
    }
    ...
    async deleteCartItemsByCartIdRaw(requestParameters: cartApiParams.DeleteCartItemsByCartIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.cartId === null || requestParameters.cartId === undefined) {
            throw new runtime.RequiredError('cartId','Required parameter requestParameters.cartId was null or undefined when calling deleteCartItemsByCartId.');
        }
        ...
        const response = await this.request({
            path: `/commerce/carts/{cartId}/bulkitems/delete`.replace(`{${"cartId"}}`, encodeURIComponent(String(requestParameters.cartId))),
            method: 'PUT',
            headers: headerParameters,
            query: queryParameters,
            body: requestParameters.requestBody,
     ...
     * Delete Multiple Cart Items By CartId
     */
    async deleteCartItemsByCartId(requestParameters: cartApiParams.DeleteCartItemsByCartIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.deleteCartItemsByCartIdRaw(requestParameters, initOverrides);
    }
    ...
    async updateCartItemsRaw(requestParameters: cartApiParams.UpdateCartItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CartItem>>> {
        const queryParameters: any = {};
        ...
        if (requestParameters.removeInvalidItems !== undefined) {
            queryParameters['removeInvalidItems'] = requestParameters.removeInvalidItems;
        }
     ...
     * Update Cart Items
     */
    async updateCartItems(requestParameters: cartApiParams.UpdateCartItemsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CartItem>> {
    ...
    async updateCartItemsByCartIdRaw(requestParameters: cartApiParams.UpdateCartItemsByCartIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<CartItem>>> {
        if (requestParameters.cartId === null || requestParameters.cartId === undefined) {
            throw new runtime.RequiredError('cartId','Required parameter requestParameters.cartId was null or undefined when calling updateCartItemsByCartId.');
        }
     ...
     * Update Cart Items By CartId
     */
    async updateCartItemsByCartId(requestParameters: cartApiParams.UpdateCartItemsByCartIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<CartItem>> {
        const response = await this.updateCartItemsByCartIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
