...
export interface ReturnApiService {
    ...
    */
    ...
    /**
    * Restock <a href=\"/pages/receive-a-return#with-reverse-logistics\">return items at a disposition location</a>.
    ...
    * @memberof ReturnApiInterface
    */
    getShipmentRaw(requestParameters: returnApiParams.GetShipmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Shipment>>;

    /**
    * Retrieves a return shipment
    * Get Return Shipment
    */
    getShipment(requestParameters: returnApiParams.GetShipmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Shipment>;
...
export class ReturnApi extends runtime.BaseAPI implements ReturnApiService {
    ...
    async getShipmentRaw(requestParameters: returnApiParams.GetShipmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Shipment>> {
        if (requestParameters.returnId === null || requestParameters.returnId === undefined) {
     ...
     * Get Return Shipment
     */
    async getShipment(requestParameters: returnApiParams.GetShipmentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Shipment> {
