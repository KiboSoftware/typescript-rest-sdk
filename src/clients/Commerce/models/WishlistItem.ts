...
/**
 * Check if a given object implements the WishlistItem interface.
 */
export function instanceOfWishlistItem(value: object): boolean {
    let isInstance = true;
...
export function WishlistItemFromJSONTyped(json: any, ignoreDiscriminator: boolean): WishlistItem {
    ...
    return {
        ...
        'purchasableStatusType': !exists(json, 'purchasableStatusType') ? undefined : json['purchasableStatusType'],
...
export function WishlistItemToJSON(value?: WishlistItem | null): any {
    ...
    return {
        ...
        'purchasableStatusType': value.purchasableStatusType,
