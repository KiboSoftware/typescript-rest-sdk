...
/**
 * Check if a given object implements the CommerceRuntimeBundledProduct interface.
 */
export function instanceOfCommerceRuntimeBundledProduct(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CommerceRuntimeBundledProductFromJSON(json: any): CommerceRuntimeBundledProduct {
    return CommerceRuntimeBundledProductFromJSONTyped(json, false);
}

export function CommerceRuntimeBundledProductFromJSONTyped(json: any, ignoreDiscriminator: boolean): CommerceRuntimeBundledProduct {
...
export function CommerceRuntimeBundledProductToJSON(value?: CommerceRuntimeBundledProduct | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
